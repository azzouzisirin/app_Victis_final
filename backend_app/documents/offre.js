...
<table  style="margin-left:30px ;margin-top:-60px;" >
    <tr  > 
        ...
        <th style="width: 80px; border:solid;"> Total HT</th>
    </tr>
    <tr  >
        ...
        <td style=" width: 140px; border:solid;"> <p style="margin-top:-82px"> ${prixGlobal} $</p></td>
...
<table style=" margin-left: 55px;" >
    <tr>
        ...
        <td style=" width: 180px;"> Total soumis à TVA</td>
    ...
    <p> <span style=" font-size: 15px;" >Engineering Concept Formation  </span>  </p> 
     <p style=" font-size: 15px;"> est un organisme enregistré sous le N° 24 37 03580 37    </p>
     <img src="https://raw.githubusercontent.com/azzouzisirin/application_victis/main/logonavbar.png" width="600px" height="150px" style="margin-left: 30px;"/><br/>
     <img src="https://raw.githubusercontent.com/azzouzisirin/application_victis/main/logonavbar2.png" width="800px" height="120px" style="margin-left: 8%;"/>
          </div>
           <br/> 
        ...
        <p> ENGINEERING CONCEPT conserve l'intégralité de ses droits d'auteur sur le contenu des formations et sur la
         ...
         <p>En cas de manquement par le client à l'une quelconque de ses obligations et quinze jours après mise en demeure
            ...
            <p>L'exécution des prestations est soumise au droit français. ENGINEERING CONCEPT recherchera une solution amiable à
                ...
                <img src="https://raw.githubusercontent.com/azzouzisirin/application_victis/main/sigClient.png" width="70%"/>
</div>

       </div>


<img src="https://raw.githubusercontent.com/azzouzisirin/application_victis/main/logonavbar2.png" width="800px" height:"70px" style="margin-left: 8%;margin-top:100px;"/>
