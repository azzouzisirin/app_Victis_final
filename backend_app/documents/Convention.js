module.exports = ({ RaisonClient,codeVilleFormation,adress_1Client,intertva,adress_2Client,CodePostalClient,nomFormation,moduleFormation,typeFormation,nombStagaire,DateDebut,DateFin,duree,LieuFormation,selectedHeure,prixHt,tva,prixAvecTVA}) => {
...
<body>
    <div  class="pdfConcension"> 
        ...
        <h1 style="margin-top: -15px;">PROFESSIONNELLE</h1>
        <h3 style="margin-top: -15px;"> (Article L. 6353-2 et R. 6353-1 du Code du Travail) </h3>
        <h2 style="color:black;font-size:26px;margin-left:70px;margin-top:-1px">ENTRE LES SOUSSIGNEES : </h2>
     
         
          <div class='divCovocaHaut'>
     
           <h2> Société ${RaisonClient}</h2>
           <p style="margin-left:25px; margin-top:-15px;font-style: italic;">${adress_1Client} </p>
           <p style="margin-left:25px;margin-top:-4px;font-style: italic; ">${adress_2Client} </p>
           <p style="margin-left:25px;margin-top:-4px; font-style: italic; ">${CodePostalClient} </p>
          ...
          <h2 style="margin-left:490px;margin-top:65px;"> Ci-après dénommée « Le bénéficiaire »</h2>
         ...
         <div class='divCovocaHaut'>
        <h4 style="margin-top:-20px ">ENGINEERING CONCEPT </h4>
        <p style="margin-top:-20px ;font-size:19x" > Dont le siège social est 8, rue Honoré de Balzac - 37000 Tours <br/>
     ...
     pouvoirs à l’effet des présentes,  </p>
           ...
           <h2 style="margin-left:490px;margin-top:45px;"> Ci-après dénommée « L’Organisme »</h2>
          <h2 style="margin-left:750px;color:black;margin-top:-15px;"> D’une part</h2>
      
          <h2 style="color:black;font-size:24px;margin-left:70px">Article 1 – OBJET, NATURE ET DURÉE DE LA FORMATION </h2>
      
     <div style="margin-left:110px">
     <p style="margin-top:10px;">Le bénéficiaire entend faire participer une partie de son personnel à l’action de <br/>
     ...
     <img src="https://raw.githubusercontent.com/azzouzisirin/application_victis/main/pied1.png" width="100%" height="150px"style="margin-top:35px"/>
     <p></p>
     ...
     <h2 style="margin-left:30px ;font-size: 22px;     "> Lieu de la formation : </h2>
     <p style="margin-left:130px;margin-top:-10px"> ${LieuFormation}<br/>
     ${codeVilleFormation}</p>

 
     <h2 style="margin-left:30px ;font-size: 22px;"> Horaires de formation : </h2>
     <p style="margin-left:130px;margin-top:-10px"> ${selectedHeure}</p>
     
    
     <h2 style="margin-left:30px;font-size: 22px;"> Moyens pédagogiques et techniques : </h2>
     <p style="margin-left:130px;margin-top:-10px">Ordinateur <br/>Connexion internet </p>
     
     
     <h2 style="margin-left:30px;font-size: 22px;"> Moyens permettant d’assurer le suivi de l’exécution de l’action :</h2>
     <p style="margin-left:130px;margin-top:-10px">Liste d'émargement des stagiaires</p>
     
   
     <h2 style="margin-left:30px;font-size: 22px;"> Moyens permettant d’apprécier les résultats de l’action :</h2>
     <p style="margin-left:130px;margin-top:-10px"> Questions ouvertes <br/>Schémas réalisés par les stagiaires </p>
     
  
     <h2 style="margin-left:30px ;font-size: 20px;"> Sanction de la formation :</h2>
     <p style="margin-left:130px;margin-top:-10px"> Une « Attestation de fin de formation » sera délivré à chaque participant</p>
  ...
  <td> </td>
     ...
     <br/>
     <img src="https://raw.githubusercontent.com/azzouzisirin/application_victis/main/pied2.png" width="100%" height="120px" />
     ...
     <img src="https://raw.githubusercontent.com/azzouzisirin/application_victis/main/pied3.png" width="100%" height="160px" style="margin-top:85px"/>
     <p></p>
     <img src="https://raw.githubusercontent.com/azzouzisirin/application_victis/main/footer.png" width="100%" height="150px" style="margin-top:10px"/>
     <br/>
     ...
     <h2> Société ${RaisonClient}</h2>
    <p> Représentant : ….............................................</p><br/>
    <p style="	font-size: 18px;">Paraphes, mention « Lu et approuvé », signature et cachet du bénéficiaire</p>
           </div>
     ...
     <img src="https://raw.githubusercontent.com/azzouzisirin/application_victis/main/pied4.png" width="100%" height="110px" style="margin-top:650px"/>
